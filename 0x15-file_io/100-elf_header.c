...
/**
 * check_elf - checkes if a file is elf
 ...
 * @e_ident: pointer to array containing the ELF data
 */
 ...
 * @e_ident: pointer to array containing the ELF OS\ABI
 */
 ...
 * @e_ident: pointer to array containing the ELF type
 * @e_type:: ELF type
 */
...
void close_elf(int elf)
{
	if (close(elf) == -1)
	{
		dprintf(STDERR_FILENO, "Error: Can't close fd %d/n", elf);
		exit(98);
	}
}

/**
 * main - Displays the elf info
 * @argc: argument count
